...
public static class CPlayerPrefs
{
    ...
    {
	    return data; //ZKW.CryptoPlayerPrefs.Helper.EncryptString (data, getEncryptionPassword (cKey));
    }
		
	private static string decrypt (string cKey)
	{
		return cKey;//ZKW.CryptoPlayerPrefs.Helper.DecryptString (PlayerPrefs.GetString (cKey), getEncryptionPassword (cKey));
	}
